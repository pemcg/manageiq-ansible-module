...
version_added: "2.4"
description:
    - Create and import encryption key using the appliance_console_cli on ManageIQ.
...
options:
    fetch_key:
        description:
            - Should the encryption key be fetched from a remote ManageIQ appliance.
        default: False
    hostname:
        description: remote ManageIQ appliance FQDN or IP to fetch the encryptyion key from.
    force_key:
        description: Forcefully create (overwrite) encryption key.
        default: False
    sshlogin:
        description: SSH user name to login with when fetching from remote ManageIQ appliance.
        default: root
    sshpassword:
        description: SSH password to login with when fetching from remote ManageIQ appliance.
        default: smartvm
'''
